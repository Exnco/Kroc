...
local ISLE = library.new("Kroc", 5013109572)
game.Players.LocalPlayer.PlayerGui:FindFirstChild("Kroc").ResetOnSpawn = false
...
RussianAvocado:addButton("Inf Storage (Probably Broken)",
function()
InfStorage = true

 
 local black =  Instance.new("BoolValue")
...
coroutine.wrap(YXVRPG_fake_script)()
   ...
   RussianAvocado:addButton("Players ESP and Full Bright",
   function()
...
RussianAvocado:addButton("TP to a random location" ,
function()
...
RussianAvocado:addButton("See Mercenary's Communication (only available from day 2)" ,
function()
...
RussianAvocado:addButton("Move While Sleeping" ,
function()
...
RussianAvocado:addSlider("Set WalkSpeed", game.Players.LocalPlayer.Character.Humanoid.WalkSpeed, 16, 100,function(value)
_G.Speed = value
...
RussianAvocado:addSlider("JumpPower(best works at 59)",game.Players.LocalPlayer.Character.Humanoid.JumpPower, 16, 500,function(value)
_G.JumpPower = value
    game.RunService.RenderStepped:Connect(function()
if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character.Humanoid then
...
_G.Message = Instance.new("Color3Value")
_G.Message.Value = Color3.fromRGB(255,255,0)
_G.Message.Name = "Thanks for using flo.Made by cire#5966 "
_G.Message.Parent = game.Players.LocalPlayer.Character["@Alerts"]
